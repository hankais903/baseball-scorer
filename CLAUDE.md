...
- 計分板上進攻中的那一隊，隊名欄會反白（`td.team-col.team-batting`）。
...
- 「在三壘與本壘之間被夾殺出局」
規則：句首不寫「擊出」；四壞／觸身寫「四壞保送」「觸身球保送」（不寫「獲得」）；野手選擇寫「選擇傳二壘」（不寫「傳向」）；滾地球不寫「接殺」（接殺只用於飛球）；跑者句在前、打點句在後、「N人出局」最後；失誤已寫進「靠○○失誤」就不再另補一句「○○發生失誤」；壘間事件寫明從哪個壘出發（「二壘跑者○○推進到三壘」）。用全形標點。
